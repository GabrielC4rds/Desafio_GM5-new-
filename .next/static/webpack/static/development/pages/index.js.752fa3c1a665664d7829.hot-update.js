...
})(["width:100%;height:50%;padding:15px 0;display:flex;flex-direction:column;p1{margin:1px 0;font-size:15px;}p2{margin:1px 0;font-size:12px;}p3{margin:1px 0;font-size:10px;text-align:justify;text-justify:auto;}@media (max-width:900px){align-items:center;height:30%;p3{text-align:justify;text-align-last:center;}}"]);
function index() {
  return __jsx(Main, {
    __source: {
...
//# sourceMappingURL=index.js.752fa3c1a665664d7829.hot-update.js.map