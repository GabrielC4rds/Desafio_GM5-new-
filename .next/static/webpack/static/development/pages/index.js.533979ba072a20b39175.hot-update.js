...
var MainFooterHolder = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
...
})(["width:100%;padding:15px 0;max-width:2000px;margin:0 auto;display:flex;align-items:flex-start;justify-content:space-around;border-top:2px solid #0199b0;@media (max-width:750px){flex-wrap:wrap;max-width:1000px;background:blue;align-items:center;justify-content:center;}"]);
...
})(["width:20%;height:25vh;display:flex;flex-direction:column;margin:0 auto;align-items:flex-start;justify-content:center;ul{display:flex;flex-direction:column;justify-content:space-between;a{color:#282828;margin:5px 0;}a1{color:purple;margin:5px 0;}}@media (max-width:750px){display:none;}"]);
...
})(["display:none;@media (max-width:750px){display:flex;width:100%;height:25vh;flex-direction:row;align-items:center;padding:0px -20\xB4x;text-align:center;justify-content:center;ul{display:flex;flex-direction:column;justify-content:space-between;align-items:center;a{color:#282828;margin:5px 0;}a1{color:purple;margin:5px 0;}}}"]);
...
})(["width:50%;height:5vh;display:flex;margin:0 35px;justify-content:space-around;align-items:center;align-self:center;flex-direction:row;"]);
function MainFooter() {
  return __jsx("div", {
    __source: {
...
//# sourceMappingURL=index.js.533979ba072a20b39175.hot-update.js.map