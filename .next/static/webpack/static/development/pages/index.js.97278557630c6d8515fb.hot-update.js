...
var DescriptionDiv = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  ...
  componentId: "ctd8j-2"
})(["width:35%;height:80%;padding:25px 0;display:flex;align-itens:center;justify-content:center;ul{display:flex;flex-direction:column;p{font-size:30px;font-weight:300;font-family:'Montserrat';color:#282828;}li2{text-align:justify;text-justify:auto;}}@media (max-width:900px){width:90%;}"]);
function index() {
  return __jsx(Main, {
    __source: {
...
//# sourceMappingURL=index.js.97278557630c6d8515fb.hot-update.js.map