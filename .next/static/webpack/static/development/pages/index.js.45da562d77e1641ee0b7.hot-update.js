...
})(["display:none;width:100%;height:25vh;flex-direction:column;margin:0 auto;align-items:flex-start;text-align:center;justify-content:center;ul{display:flex;flex-direction:column;justify-content:space-between;a{color:#282828;margin:5px 0;}a1{color:purple;margin:5px 0;}}@media (max-width:750px){display:flex;}"]);
...
function MainFooter() {
  return __jsx("div", {
    ...
    __self: this
  }, "safjasjf skflakfkas\xE7f falasff"), __jsx("a1", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 162
    },
...
//# sourceMappingURL=index.js.45da562d77e1641ee0b7.hot-update.js.map