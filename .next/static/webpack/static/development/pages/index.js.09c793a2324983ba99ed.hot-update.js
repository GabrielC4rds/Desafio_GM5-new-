...
})(["width:50%;height:5vh;display:flex;margin:0 35px;justify-content:space-around;align-items:center;align-self:center;flex-direction:row;@media (max-width:750px){padding-left:40px;}"]);
function MainFooter() {
  return __jsx("div", {
    __source: {
...
//# sourceMappingURL=index.js.09c793a2324983ba99ed.hot-update.js.map