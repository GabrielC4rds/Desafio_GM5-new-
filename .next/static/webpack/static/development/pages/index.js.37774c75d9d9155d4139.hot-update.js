...
var Main = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  ...
  componentId: "ctd8j-0"
})(["width:100%;height:75vhvh;margin-top:10vh;display:flex;align-itens:center;justify-content:center;@media (max-width:900px){flex-direction:column;}"]);
var PhotoDiv = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "WhoWeAre__PhotoDiv",
  componentId: "ctd8j-1"
})(["width:40%;height:55%;background:#0199b0;@media (max-width:900px){align-self:center;height:100vh;width:85%;}"]);
var DescriptionDiv = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  ...
  componentId: "ctd8j-2"
})(["width:35%;height:80%;display:flex;padding:25px 0;align-itens:center;justify-content:center;ul{display:flex;flex-direction:column;li1{font-size:20px;}li2{margin-top:15px;text-align:justify;text-justify:auto;}}@media (max-width:900px){width:90%;}"]);
function index() {
  return __jsx(Main, {
    __source: {
...
//# sourceMappingURL=index.js.37774c75d9d9155d4139.hot-update.js.map