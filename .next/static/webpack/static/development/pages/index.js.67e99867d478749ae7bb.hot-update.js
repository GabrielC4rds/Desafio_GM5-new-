...
})(["width:20%;height:25vh;display:flex;flex-direction:column;margin:0 auto;align-items:flex-start;justify-content:center;ul{display:flex;flex-direction:column;justify-content:space-between;a{color:#282828;margin:5px 0;font-family:Montserrat;font-weight:bold;}a:nth-child(1){cursor:pointer;color:#775a97;margin:5px 0;font-family:Montserrat;font-weight:bold;}}@media (max-width:750px){display:none;}"]);
...
})(["display:none;@media (max-width:750px){display:flex;width:100%;height:40vh;flex-direction:column;align-items:center;padding-right:30px;text-align:center;justify-content:space-around;ul{display:flex;flex-direction:column;justify-content:space-between;align-items:center;a{color:#282828;margin:5px 0;font-family:Montserrat;font-weight:bold;}a:nth-child(1){color:#775a97;margin:5px 0;font-family:Montserrat;font-weight:bold;}}}"]);
...
//# sourceMappingURL=index.js.67e99867d478749ae7bb.hot-update.js.map