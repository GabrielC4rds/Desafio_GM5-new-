...
})(["width:50%;height:5vh;display:flex;justify-content:space-around;align-items:flex-start;align-self:center;flex-direction:row;@media (max-width:750px){padding-left:40px;}"]);
function MainFooter() {
  return __jsx("div", {
    __source: {
...
//# sourceMappingURL=index.js.7384c1479dd524fbd47d.hot-update.js.map