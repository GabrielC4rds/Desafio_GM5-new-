...
})(["border-bottom:1px solid #939393;display:flex;justify-content:flex-start;align-items:center;height:25%;width:100%;cursor:pointer;:transition .5 easehover{transform:scale(1.1);}p1{font-size:23px;color:#0199b0;font-weight:bold;}p2{font-size:12px;color:#282828;margin-top:5px;margin-left:5px;}@media (max-width:900px){padding:0 20px;height:20%;width:70%;display:flex;align-items:center;flex-direction:row;}"]);
function index() {
  return __jsx(Main, {
    __source: {
...
//# sourceMappingURL=index.js.7c6a208494a65c4f17c9.hot-update.js.map