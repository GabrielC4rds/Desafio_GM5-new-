...
var PhotoBlock = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "OurServices__PhotoBlock",
  componentId: "xf3luz-4"
})(["background:url(", ");width:70%;height:50%;@media (max-width:900px){flex-direction:column;width:100%;height:30vh;}"], function (props) {
...
function index() {
  return __jsx(Main, {
    ...
    return __jsx(Block, {
      ...
      backgroundImage: props.res.Image,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 118
      },
...
//# sourceMappingURL=index.js.c36e3c0df7708997d8f1.hot-update.js.map