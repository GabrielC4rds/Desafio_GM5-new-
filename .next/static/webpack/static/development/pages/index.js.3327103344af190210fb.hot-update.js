...
})(["border-bottom:1px solid grey;display:flex;justify-content:flex-start;align-items:center;height:25%;width:100%;p1{font-size:23px;color:blue;font-weight:bold;}p2{font-size:12px;margin-top:5px;margin-left:5px;}"]);
function index() {
  return __jsx(Main, {
    __source: {
...
//# sourceMappingURL=index.js.3327103344af190210fb.hot-update.js.map