...
var Main = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  ...
  componentId: "ctd8j-0"
})(["width:100%;height:25vh;margin-top:10vh;display:flex;justify-content:center;@media (max-width:900px){flex-direction:column;height:60vh;}@media (min-width:375px){height:200vh;}"]);
var PhotoDiv = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].img.withConfig({
  displayName: "WhoWeAre__PhotoDiv",
  componentId: "ctd8j-1"
})(["width:40%;height:70%;@media (max-width:900px){align-self:center;height:20vh;width:85%;}"]);
...
//# sourceMappingURL=index.js.0ce191bf6fcedf9d1d33.hot-update.js.map