...
})(["background:green;height:100%;width:20%;padding:0 20px;"]);
...
})(["height:70%;width:100%;background:aqua;"]);
...
})(["background:red;border-bottom:2px solid grey;display:flex;justify-content:flex-start;align-items:flex-start;height:25%;width:100%;ul{display:flex;align-items:flex-start;justify-content:flex-start;p1{font-size:20px;color:blue;font-weight:bold;}}"]);
function index() {
  return __jsx(Main, {
    __source: {
...
//# sourceMappingURL=index.js.83322329ca403ce47edd.hot-update.js.map