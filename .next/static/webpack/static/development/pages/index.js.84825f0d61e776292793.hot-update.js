...
var DescriptionDiv = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  ...
  componentId: "ctd8j-2"
})(["width:35%;height:80%;display:flex;padding:25px 0;align-itens:center;justify-content:center;ul{display:flex;flex-direction:column;li1{font-size:20px;}li2{margin-top:15px;text-align:justify;text-justify:auto;}}@media (max-width:900px){width:100%;}"]);
function index() {
  return __jsx(Main, {
    __source: {
...
//# sourceMappingURL=index.js.84825f0d61e776292793.hot-update.js.map