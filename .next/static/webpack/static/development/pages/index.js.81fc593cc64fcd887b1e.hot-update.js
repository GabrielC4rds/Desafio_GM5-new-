...
})(["background:red;border-bottom:2px solid grey;display:flex;justify-content:flex-start;align-items:center;height:25%;width:100%;ul{display:flex;align-items:flex-start;justify-content:flex-start;p1{font-size:20px;color:blue;font-weight:bold;}}"]);
function index() {
  return __jsx(Main, {
    __source: {
...
//# sourceMappingURL=index.js.81fc593cc64fcd887b1e.hot-update.js.map