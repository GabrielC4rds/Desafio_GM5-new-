...
})(["width:60%;height:5vh;margin:0 0;align-self:flex-start;display:flex;justify-content:space-between;align-items:center;align-self:center;flex-direction:row;transition .5s ease;:hover{transform:scale(1.1);}@media (max-width:750px){padding-left:40px;}"]);
function MainFooter() {
  return __jsx("div", {
    __source: {
...
//# sourceMappingURL=index.js.5ffe5f9179d3b404f016.hot-update.js.map