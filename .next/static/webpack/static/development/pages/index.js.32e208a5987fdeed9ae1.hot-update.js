...
})(["background:red;border-bottom:2px solid grey;display:flex;justify-content:flex-start;align-items:center;height:25%;width:100%;p1{font-size:25px;color:blue;font-weight:bold;}p2{font-size:15px;margin-top:5px;}"]);
function index() {
  return __jsx(Main, {
    __source: {
...
//# sourceMappingURL=index.js.32e208a5987fdeed9ae1.hot-update.js.map