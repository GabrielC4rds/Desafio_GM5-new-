...
})(["width:60%;height:5vh;margin-bottom:6vh;align-self:flex-start;display:flex;justify-content:space-between;align-items:center;align-self:center;flex-direction:row;img{transition .5s ease;:hover{transform:scale(1.1);}}@media (max-width:750px){padding-left:40px;}"]);
function MainFooter() {
  return __jsx("div", {
    __source: {
...
//# sourceMappingURL=index.js.2ad16995416ff3107d3a.hot-update.js.map