...
})(["width:50%;height:5vh;display:flex;margin:0 35px;justify-content:space-around;align-items:center;align-self:center;flex-direction:row;@media (max-width:750px){padding-left:30px;}"]);
function MainFooter() {
  return __jsx("div", {
    __source: {
...
//# sourceMappingURL=index.js.9f51d3472449cd71af97.hot-update.js.map