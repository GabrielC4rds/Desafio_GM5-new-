...
})(["display:none;@media (max-width:750px){display:flex;width:100%;height:25vh;flex-direction:row;align-items:center;padding:0px -20x;text-align:center;justify-content:center;ul{display:flex;flex-direction:column;justify-content:space-between;align-items:center;a{color:#282828;margin:5px 0;}a1{color:purple;margin:5px 0;}}}"]);
...
//# sourceMappingURL=index.js.f26ab9346016cd70a103.hot-update.js.map