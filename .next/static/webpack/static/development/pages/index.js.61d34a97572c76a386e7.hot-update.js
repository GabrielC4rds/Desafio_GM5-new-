...
})(["width:100%;padding:15px 0;max-width:1250px;margin:0 auto;display:flex;align-items:flex-start;justify-content:space-around;border-top:2px solid #0199b0;@media (max-width:750px){flex-wrap:wrap;justify-content:center;}"]);
...
})(["width:20%;height:20vh;display:flex;flex-direction:column;margin:0 auto;align-items:flex-start;justify-content:space-around;ul{display:flex;flex-direction:column;}"]);
function MainFooter() {
  return __jsx("div", {
    __source: {
...
//# sourceMappingURL=index.js.61d34a97572c76a386e7.hot-update.js.map