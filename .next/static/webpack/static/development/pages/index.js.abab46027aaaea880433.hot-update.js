...
})(["background:aqua;height:100%;width:55%;display:flex;flex-direction:column;"]);
...
})(["height:20%;width:100%;background:red;P{font-size:30px;}"]);
...
})(["height:80%;width:100%;background:purple;display:flex;flex-direction:row;"]);
...
})(["background:aqua;width:35%;height:100%;"]);
...
function index() {
  return __jsx(Main, {
    ...
    __self: this
  }, "sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur."))), __jsx(PhotoBlock2, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 94
    },
...
//# sourceMappingURL=index.js.abab46027aaaea880433.hot-update.js.map