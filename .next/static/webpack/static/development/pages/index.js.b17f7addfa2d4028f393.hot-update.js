...
})(["background:red;border-bottom:2px solid grey;display:flex;justify-content:flex-start;align-items:center;height:25%;width:100%;ul{display:flex;flex-direction:row;p1{font-size:20px;color:blue;font-weight:bold;}}"]);
function index() {
  return __jsx(Main, {
    __source: {
...
//# sourceMappingURL=index.js.b17f7addfa2d4028f393.hot-update.js.map