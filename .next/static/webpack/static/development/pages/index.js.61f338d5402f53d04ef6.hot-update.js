...
})(["width:60%;height:5vh;margin:0;display:flex;justify-content:space-between;align-items:center;align-self:center;flex-direction:row;@media (max-width:750px){padding-left:40px;}"]);
function MainFooter() {
  return __jsx("div", {
    __source: {
...
//# sourceMappingURL=index.js.61f338d5402f53d04ef6.hot-update.js.map