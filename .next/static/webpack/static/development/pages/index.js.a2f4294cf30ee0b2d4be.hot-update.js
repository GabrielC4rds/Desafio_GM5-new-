...
})(["border-bottom:1px solid grey;display:flex;justify-content:flex-start;align-items:center;height:25%;width:100%;p1{font-size:23px;color:#0199b0;font-weight:bold;}p2{font-size:12px;color:#282828;margin-top:5px;margin-left:5px;}"]);
function index() {
  return __jsx(Main, {
    __source: {
...
//# sourceMappingURL=index.js.a2f4294cf30ee0b2d4be.hot-update.js.map