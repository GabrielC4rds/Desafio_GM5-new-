...
})(["width:60%;height:5vh;margin-bottom:5vh;align-self:flex-start;display:flex;justify-content:space-between;align-items:center;align-self:center;flex-direction:row;img{transition .5s ease;:hover{transform:scale(1.1);}}@media (max-width:750px){padding-left:40px;}"]);
function MainFooter() {
  return __jsx("div", {
    __source: {
...
//# sourceMappingURL=index.js.c7733e50cb8b3adfcb32.hot-update.js.map