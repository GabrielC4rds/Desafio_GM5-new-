...
})(["width:20%;height:25vh;display:flex;flex-direction:column;margin:0 auto;align-items:flex-start;justify-content:center;background:blue;ul{display:flex;flex-direction:column;justify-content:space-between;a{margin:5px 0;}}"]);
...
})(["width:75%;height:10vh;align-self:center;display:flex;justify-content:flex-start;align-items:center;background:green;flex-direction:row;"]);
function MainFooter() {
  return __jsx("div", {
    __source: {
    ...
    __self: this
  }, "asdasfjiasjfoa wdoasfoaska asfalsfka"), __jsx("a", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 86
    },
    ...
    src: "./static/myfolder/img/facebook_icon",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 99
    },
...
//# sourceMappingURL=index.js.4332120cea6008d8c278.hot-update.js.map