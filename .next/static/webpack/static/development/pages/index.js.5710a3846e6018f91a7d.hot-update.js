...
})(["display:none;@media (max-width:750px){display:flex;width:100%;height:25vh;flex-direction:row;align-items:center;padding:0px -20px;text-align:center;justify-content:center;ul{display:flex;flex-direction:column;justify-content:space-between;align-items:center;a{color:#282828;margin:5px 0;}a1{color:purple;margin:5px 0;}}}"]);
...
//# sourceMappingURL=index.js.5710a3846e6018f91a7d.hot-update.js.map